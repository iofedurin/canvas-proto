...
import {Graphics, InteractionEvent, InteractionManager} from 'pixi.js';
import {Viewport} from 'pixi-viewport';
import {Carto4ka} from './classes';
...
export class AppComponent implements AfterViewInit {
  ...
  initPixiAndViewPort() {
    this.pixiApp = new PIXI.Application({resizeTo: this.canvasWrap.nativeElement});
  ...
  addContainer() {
    const card = new Carto4ka();
    this.viewport.addChild(card);
    //console.log(container);
    //this.viewport.addChild(container.q[0]);
    //this.viewport.addChild(container.q[1]);
